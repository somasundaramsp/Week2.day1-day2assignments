...
public class DuplicateLead {
	...
	public static void main(String[] arg) {
		...
		WebElement elementDublicateButton = driver.findElement(By.className("subMenuButton"));
		elementDublicateButton.click();

		WebElement elementCompanyNameD = driver.findElement(By.id("createLeadForm_companyName"));
		elementCompanyNameD.clear();

		elementCompanyNameD.sendKeys("Somu Technologies");

		WebElement elementfirstnameD = driver.findElement(By.id("createLeadForm_firstName"));
		elementfirstnameD.clear();

		elementfirstnameD.sendKeys("Somasundaramsp");

		WebElement elementCreateButtonD = driver.findElement(By.name("submitButton"));
		elementCreateButtonD.click();
